...
--- FLASK WEB SUNUCUSU (APEX BOT MİMARİSİ) ---

app = Flask(name)

@app.route('/')
def home():
# ApexBot gibi cron-job pinglerini sorunsuz karşılayan hafif yanıt
return jsonify({"status": "active", "bot": "ScalpBot Pro"}), 200
...
# Arka Plan Parite Tarama Motorunu Başlat  
